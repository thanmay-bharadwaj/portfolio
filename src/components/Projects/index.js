  ...
  return (
    <Container id="projects">
      <Wrapper>
        ...
        <Desc>
        Here are some of my projects and certifications. For more Projects visit my <a href="https://github.com/thanmay-bharadwaj"style={{ color: '#66fcf1' }} target = "_blank" >GitHub Profile</a>.
        </Desc>
        <ToggleButtonGroup >
          {toggle === 'all' ?
